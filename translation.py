...
URL | filename | username | password"""
    ...
    AFTER_SUCCESSFUL_UPLOAD_MSG = "Thanks for using @Kakashiuploaderobot)"
    AFTER_SUCCESSFUL_UPLOAD_MSG_WITH_TS = "DOWNLOADED in {} seconds.\nUploaded in {} seconds.\n\n@xurluploaderbot"
    SAVED_CUSTOM_THUMB_NAIL = "Custom thumbnail saved. This image will be used as thumbnail."
...
2. Send Image for Custom Thumbnail (Optional).
3. Select the button.
...
If bot didn't respond, contact @THE_KAKASHI_COPY_NINJA"""
    ...
    CANCEL_STR = "PROCESS HAS BEEN CANCELLED..!!"
